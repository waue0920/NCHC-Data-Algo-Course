...
public class KMeansClusteringJob {
    ...
    public static void main(String[] args) throws IOException,
        ...
        while (counter > 0) {
            ...
            result = new Path("files/clustering/depth_" + (iteration - 1) + "/part-r-00000");
            showCluster(result,fs,conf);
        }

    }

    private static void showCluster(Path result, FileSystem fs, Configuration conf) throws IOException {
